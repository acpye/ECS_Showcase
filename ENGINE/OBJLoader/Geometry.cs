...
namespace OpenGL.ENGINE.OBJLoader
{
    public class Group
    {
    ...
    public class Geometry
    {
        ...
        public (Vector3, Vector3) CalculateAABB()
        {
            ...
            {
                for (int i = 0; i < group.vertices.Count; i += 3)
                {
        ...
        public void LoadObject(string filename)
        {
            try
            {
                ...
                foreach (DataGroup group in obj.Groups)
                {
        ...
        public LoadResult LoadOBJObject(string filename)
        {
            ...
            LoadResult obj = objLoader.Load(fileStream);
            fileStream.Close();
            return obj;
        }
